...
try
    close_position = 0;
    % io = getlinio('motor_no_feedforward_Kvi_T_load');
    % sys_position = linearize('motor_no_feedforward_Kvi_T_load', [io(1), io(5)]);
    ...
    close_friction = 0;
    io = getlinio('motor_no_feedforward_Kvi_T_load');
    sys_velocity = linearize('motor_no_feedforward_Kvi_T_load', [io(1), io(2)]);
...
sim("motor_no_feedforward_Kvi_T_load.slx")
